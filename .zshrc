...
autoload -Uz imv try_until extract_numbers add checkout_remote checkout_remote_merge merge_current findf findd git-checkout-github vim-last-modified update-branch
