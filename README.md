...
Once you get into a bash terminal, install packages we'll need:
    ...
    sudo apt-get install --yes -qq parallel wget build-essential bison zlib1g-dev libyaml-dev libssl-dev libgdbm-dev libreadline-dev libncurses5-dev libffi-dev software-properties-common python2.7 exuberant-ctags libpq-dev redis-server ncdu silversearcher-ag fd-find pv &&
