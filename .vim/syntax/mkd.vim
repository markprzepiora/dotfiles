...
"syn region htmlBold     start=/abcdefghijklmnopqrstuvwxyz1234567/     end=/xxx/   contains=@Spell,htmlItalic
"syn region htmlItalic   start=/abcdefghijklmnopqrstuvwxyz1234567/     end=/xxx/      contains=htmlBold,@Spell
"syn region htmlBold     start=/abcdefghijklmnopqrstuvwxyz1234567/     end=/xxx/       contains=htmlItalic,@Spell
"syn region htmlItalic   start=/abcdefghijklmnopqrstuvwxyz1234567/     end=/xxx/        contains=htmlBold,@Spell

" [link](URL) | [link][id] | [link][]
syn region mkdLink matchgroup=mkdDelimiter      start="\!\?\[" end="\]\ze\s*[[(]" contained
"contains=@Spell 
...
"syn region  mkdCode start='^\s{4,}' skip='^$' end='^\z1\@!'
"syn region  mkdCode start='^\s\{4,}' skip='^$' end='^$'
syn region  mkdCode start='^$\n^\s\{4,}' end='^$'
      "\ contains=@NoSpell
...
syn region htmlH2       start="^##"                  end="\($\|#\+\)" contains=@Spell
syn region htmlH3       start="^###"                 end="\($\|#\+\)" contains=@Spell
syn region htmlH4       start="^####"                end="\($\|#\+\)" contains=@Spell
syn region htmlH5       start="^#####"               end="\($\|#\+\)" contains=@Spell
syn region htmlH6       start="^######"              end="\($\|#\+\)" contains=@Spell
syn match  htmlH1       /^.\+\n=\+$/ contains=@Spell
syn match  htmlH2       /^.\+\n-\+$/ contains=@Spell
