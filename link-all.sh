...
FILES=".vim .vimrc .gitconfig .githelpers .tmux.conf .zshrc .zshenv .oh-my-zsh .zprofile .irbrc .psqlrc .npmrc .dir_colors .direnvrc .pryrc .ExifTool_config .config/starship.toml"
